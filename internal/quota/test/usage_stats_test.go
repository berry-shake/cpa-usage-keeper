...
func (provider *failOnceGroupedUsageStatsProvider) SumByAuthIndexAndModelKeyword(context.Context, string, string, time.Time, *time.Time) (repository.UsageWindowStats, error) {
	return repository.UsageWindowStats{}, nil
}
